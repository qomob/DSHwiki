...
export const UI = {
  zh: {
    ...
    wiki: {
      ...
      collapse: '收起',
      expand: '展开',
      apiPromoTitle: '配置你的第一个 API Key',
      apiPromoAd: '推广',
      apiPromoModel: '推荐模型',
      apiPromoPrice: '价格（入/出）*',
      apiPromoBonus: '新用户',
      apiPromoCta: '获取 API Key →',
      apiPromoDisclosure: '部分链接含推广返利：经此注册本站或获佣金/额度，你的价格不变',
      apiPromoNote: '* 每百万 tokens，以各平台官网为准；DeepSeek 将于 8/17 起实行峰谷定价',
    },
    plugins: {
      label: '插件',
      title: '社区插件一览',
  ...
  en: {
    ...
    wiki: {
      ...
      collapse: 'Collapse',
      expand: 'Expand',
      apiPromoTitle: 'Get your first API key',
      apiPromoAd: 'Ad',
      apiPromoModel: 'Model',
      apiPromoPrice: 'Price (in/out)*',
      apiPromoBonus: 'New users',
      apiPromoCta: 'Get API key →',
      apiPromoDisclosure: 'Some links are affiliate: signing up via them may earn us a commission or credit at no extra cost to you',
      apiPromoNote: '* Per 1M tokens; see official pricing. DeepSeek moves to peak/off-peak pricing on Aug 17',
    },
    plugins: {
      label: 'Plugins',
